...
import { isRecruiterLoggedIn } from "@/lib/auth";
        ...
        <div className="grid gap-4 lg:grid-cols-[260px_1fr]">
          <aside className="space-y-3">
            ...
            <Card className="p-2 space-y-1">
              <NavItem to="/recruiter/dashboard" label="Dashboard" icon={<LayoutDashboard className="h-4 w-4" />} />
              <NavItem to="/recruiter/jobs" label="Jobs" icon={<Briefcase className="h-4 w-4" />} />
              <NavItem to="/recruiter/candidates" label="Candidates" icon={<Users className="h-4 w-4" />} />
            </Card>
          </aside>
